<main class="container">
    ...
    <section class="lots">
        <div class="lots__header">
            <h2>
                Открытые лоты<?=($category_id)?(' в категории ' . htmlspecialchars(getCatById($categories,$category_id))):'';?>
            </h2>
            ...
            <?php foreach ($lots as $lot): ?>
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="http://<?=$_SERVER['SERVER_NAME'];?>/public/uploads/<?=htmlspecialchars($lot['pic']);?>"
                    ...
                    <div class="lot__info">
                        ...
                        <h3 class="lot__title">
                            <a class="text-link" href="/lot/<?=$lot['id'];?>">
